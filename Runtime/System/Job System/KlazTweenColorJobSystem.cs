...
namespace com.Klazapp.Utility
{
    ...
    [BurstCompile]
#endif
    public struct KlazTweenColorJobSystem : IJobParallelFor
    {
        [WriteOnly]
        public NativeArray<Color> currentValues;
        [ReadOnly] 
        public NativeArray<Color> startValues;
        [ReadOnly]
        public NativeArray<Color> endValues;
        ...
        public void Execute(int index)
        {
            ...
            currentValues[index] = mathExtension.lerp(startValues[index], endValues[index], progress);
        }
    }
}