...
namespace com.Klazapp.Utility
{
    ...
    [BurstCompile]
#endif
    public struct KlazTweenFloat2JobSystem : IJobParallelFor
    {
        [WriteOnly]
        public NativeArray<float2> currentValues;
        [ReadOnly] 
        public NativeArray<float2> startValues;
        [ReadOnly]
        public NativeArray<float2> endValues;
