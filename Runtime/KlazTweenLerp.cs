...
public static class KlazTweenLerp
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float2 Lerp(float2 start, float2 end, float progress)
    {
        return math.lerp(start, end, progress);
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float3 Lerp(float3 start, float3 end, float progress)
    {
        return math.lerp(start, end, progress);
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float4 Lerp(float4 start, float4 end, float progress)
    {
        return math.lerp(start, end, progress);
    }
    ...
    {
        return math.slerp(start, end, progress);
    }
